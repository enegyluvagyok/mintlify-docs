...
### MySQL adatbázis előkészítése és inicializálása
...
### Supervisor konfigurálása (Octane + Queue worker + Reverb)
...
### Első rendszergazda fiók létrehozása
